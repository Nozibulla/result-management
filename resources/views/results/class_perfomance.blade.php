	...
	<div class="panel panel-default">
		<div class="panel-heading" data-toggle="collapse" data-parent="#accordion" href="#collapse1">
			<h4 class="panel-title">
				Show Perfomance by Class
			</h4>
		</div>
		<div id="collapse1" class="panel-collapse collapse in">
			<div class="panel-body form-inline">
				{!! Form::open(['method' => 'POST', 'target' => '_blank', 'url' => 'class_perfomance_by_class', 'class' => 'form-horizontal']) !!}
	...
	<div class="panel panel-default">
		<div class="panel-heading"  data-toggle="collapse" data-parent="#accordion" href="#collapse2">
			<h4 class="panel-title">
				...
				Show Perfomance by Shift
			</h4>
		</div>
		<div id="collapse2" class="panel-collapse collapse">
			<div class="panel-body form-inline">
				{!! Form::open(['method' => 'POST', 'target' => '_blank', 'url' => 'class_perfomance_by_shift', 'class' => 'form-horizontal']) !!}
	...
	<div class="panel panel-default">
		<div class="panel-heading" data-toggle="collapse" data-parent="#accordion" href="#collapse3">
			<h4 class="panel-title" >
				...
				Show Perfomance by Batch
			</h4>
		</div>
		<div id="collapse3" class="panel-collapse collapse">
			<div class="panel-body form-inline">
				{!! Form::open(['method' => 'POST', 'target' => '_blank', 'url' => 'class_perfomance_by_batch', 'class' => 'form-horizontal']) !!}
