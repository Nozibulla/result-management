...
<body>
	...
	<div class="student_info">
		...
		<h3 class="text-center"><strong>Name: </strong>{{ $indivisual_results[0]->name }} |
			<strong>Roll: </strong> {{ $indivisual_results[0]->roll }} |
			<strong>Class: </strong>{{ $indivisual_results[0]->class }} |
			<strong>Batch: </strong>{{ $indivisual_results[0]->batch }} |
			<strong>Shift: </strong>{{ $indivisual_results[0]->shift }} |
			<strong>Month: </strong>{{ $indivisual_results[0]->month }} |
			<strong>Year: </strong>{{ $indivisual_results[0]->year }}</h3>
