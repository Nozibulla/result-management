	...
	<div class="row">
		<div class="col-md-12 ">
			...
			<div class="panel panel-default">
				<div class="panel-heading"><h2 class="text-center">Class Perfomance Class:{{ $class }} Shift: {{ $shift }} Year: {{ $year }}</h2></div>

				<div class="panel panel-default">
					<div class="panel-heading">Class Perfomance by Shift</div>
